...
export default function MyFirstMerchForm() {
  ...
  const handleSizeChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const newSizeCounts = {
      ...sizeCounts,
      [name as keyof typeof sizeCounts]: numValue,
    };
    ...
    <div className="max-w-3xl mx-auto p-4">
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-600">
            Shirts are printed on <strong>AS Colour Block Tubular</strong> high
            quality blanks that feel great and last. Check out the{" "}
            <a
              href="https://www.ascolour.com.au/block-tubular-tee-5050t/"
            ...
            <strong>
              <a
                href="https://nsw.headwear.com.au/cotton-twill-cap/"
                className="text-blue-600 underline"
                target="_blank"
              >
            ...
            <strong>
              <a
                href="https://www.ascolour.com.au/parcel-tote-1000/"
                className="text-blue-600 underline"
                target="_blank"
              >
